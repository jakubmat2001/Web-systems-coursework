...
function UpdateQuote2() {
  ...
  const fetchQuote = async () => {
    try {
      ...
      const response = await axios.get(`http://127.0.0.1:8000/api/quotes2/${quoteId}`, {
        headers: {
  ...
  const updateQuote = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://127.0.0.1:8000/api/quotes2/${quoteId}`, values, {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
